...
export const appStyles = StyleSheet.create({
  ...
  poolTrendBadgeUp: {
    backgroundColor: 'rgba(184, 255, 102, 0.1)',
    borderColor: 'rgba(184, 255, 102, 0.32)',
  },
  poolTrendBadgeDown: {
  ...
  tileButton: {
    alignItems: 'center',
    backgroundColor: 'rgba(232, 255, 83, 0.9)',
